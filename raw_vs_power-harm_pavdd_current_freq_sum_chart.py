...
from pySpecAn.pySpecAn import RS_SpectrumAnalyzer
import numpy as np
import pyPSU.pyPSU
...
frequencies = [868e6, 876e6, 902e6, 915e6, 928e6]
...
psu = pyPSU.pyPSU.PSU("ASRL3::INSTR")
psu.selectOutput(1)
...
workbook_name = board_name + '_Raw_PAVDD_Freq_vs_Power-Harmonic-Current_test-results_sum_chart.xlsx'
    ...
    for pavdd in pavdd_levels:
        ...
        while n <= harm_order_up_to:
            ...
            if __name__ == "__main__":
                wstk_echo = False
                address = 'TCPIP::169.254.250.234::INSTR'
                specan = RS_SpectrumAnalyzer(resource_name=address)
