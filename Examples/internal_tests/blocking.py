...
WSTK_COM_Port = 'COM7'                              # WSTK board COM port
...
SigGen_Power_Start_dBm = -103                       # Signal Generator start power, used on the desired signal path
SigGen_Power_Stop_dBm = -115                        # Signal Generator stop power, used on the desired signal path
...
Blocker_FrequencyOffset_Start_Hz = -4e6             # blocker signal start frequency offset
Blocker_FrequencyOffset_Stop_Hz = 4e6               # blocker signal stop frequency offset
...
blocking_settings = Blocking.Settings(
    ...
    siggen_per_packet_filename=Per_Packet_Filename,
    siggen_pattern_repeat = Pattern_Repeat,
    logger_settings=Logger.Settings(module_name="rxtests.blocking", logging_level=Level.INFO),
    siggen_logger_settings = Logger.Settings(logging_level=Level.INFO),
    specan_logger_settings = Logger.Settings(logging_level=Level.INFO),
    wstk_logger_settings = Logger.Settings(logging_level=Level.INFO),
    blocking_logger_settings=Logger.Settings(logging_level=Level.INFO)
)
