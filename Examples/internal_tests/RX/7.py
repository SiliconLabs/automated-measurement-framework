...
CTUNE_Tuning_w_SA = True                           # CTUNE tuning with the spectrum analyzer, for blocking measurements do not use SA for CTUNE tuning, use SG below instead
...
measurement_sensitivity = Sensitivity(settings=sensitivity_settings,chip_name="7",board_name="7")
