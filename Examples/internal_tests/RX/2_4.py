...
Measure_RSSI_Sweep = True                          # RSSI sweep versus input power and frequency
...
SigGen_Power_List = [-80,-85,-90,-95,-100]                        # Number of power steps, used on the desired signal path
...
Frequency_SigGen_List_Hz = [868e6,915e6]                     # List of SigGen frequencies. This list is used when given, if it is None then list is created from start, stop and steps defined above.
