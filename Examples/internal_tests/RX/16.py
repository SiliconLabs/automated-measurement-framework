...
# DUT names
Chip_Name = '16'                             # Chip name of DUT
Board_Name = '16'                             # Board name of DUT
...
Blocking_Siggen_Address = 'GPIB1::5::INSTR' # Address of the generator used to generate blocking signal
...
if Measure_Blocking_w_Sensitivity:
    measurement_blocking = Blocking(settings=blocking_settings,chip_name="16",board_name="16")
