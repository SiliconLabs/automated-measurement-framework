...
# DUT names
Chip_Name = '13'                             # Chip name of DUT
Board_Name = '13'                             # Board name of DUT
...
Blocker_FrequencyOffset_List_Hz = [-8e6, -4e6, 4e6, 8e6]       # List of frequency offset points of the blocker signal. This list is used when given, if it is None then list is created from start, stop and steps defined above.
...
Blocker_Power_List_dBm = [-40,-35,-30,-25]                       # List of power points of the blocker signal. This list is used when given, if it is None then list is created from start, stop and steps defined above.
...
if Measure_Blocking_w_Sensitivity:
    measurement_blocking = Blocking(settings=blocking_settings,chip_name="13",board_name="13")
