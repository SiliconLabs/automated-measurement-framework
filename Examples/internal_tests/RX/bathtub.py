...
Measure_Sensitivity_w_FrequencyOffset = True       # Sensitivity measurement with frequency offsets defined
...
SigGen_Power_Num_Steps = 26                         # Number of power steps, used on the desired signal path
...
Blocker_FrequencyOffset_Start_Hz = -20e6             # blocker signal start frequency offset
Blocker_FrequencyOffset_Stop_Hz = 20e6               # blocker signal stop frequency offset
Blocker_FrequencyOffset_Num_Steps = 10               # number of frequency offset points of the blocker signal
...
Frequency_Offset_Start_Hz = -20e3                    # frequency offset start for offset-Sensitivity test
Frequency_Offset_Stop_Hz = 20e3                      # frequency offset stop for offset-Sensitivity test
